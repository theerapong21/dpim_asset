...
<html lang="en">
    ...
    <body class=" login">
        <div class="logo">
         <img alt="" src="/assets/pages/img/dpim_logo.png" width="70"/>
        </div>
        <!-- BEGIN LOGIN -->
        @yield('content')
        <!-- END LOGIN -->
...
<![endif]-->
        ...
        <script src="../assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript">
        </script>
